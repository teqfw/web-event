...
export default class TeqFw_Web_Event_Back_Event_Front_Authenticated {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{[data]: TeqFw_Web_Event_Back_Event_Front_Authenticated.Dto, [meta]: TeqFw_Core_Shared_App_Event_Message_Meta.Dto}} [data]
         * @return {{data: TeqFw_Web_Event_Back_Event_Front_Authenticated.Dto, meta: TeqFw_Core_Shared_App_Event_Message_Meta.Dto}}
         */
        this.createDto = (data) => {
