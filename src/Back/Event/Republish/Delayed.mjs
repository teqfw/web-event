...
export default class TeqFw_Web_Event_Back_Event_Republish_Delayed {
    constructor(spec) {
        ...
        // INSTANCE METHODS
        /**
         * @param {{[data]: TeqFw_Web_Event_Back_Event_Republish_Delayed.Dto, [meta]: TeqFw_Core_Shared_Mod_Event_Message_Meta.Dto}} [data]
         * @return {{data: TeqFw_Web_Event_Back_Event_Republish_Delayed.Dto, meta: TeqFw_Core_Shared_Mod_Event_Message_Meta.Dto}}
         */
        this.createDto = (data) => {
